...
import { ShieldCheck, User, Search, FileText } from 'lucide-react';
            ...
            <div key={claim.ClaimID} className="admin-card p-6 space-y-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-bold px-3 py-1 rounded-lg uppercase bg-emerald-50 text-emerald-700 border border-emerald-200 flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-600" /> Verified Claim
                  </span>
                </div>
